========================================================================
    KONSOLENANWENDUNG: Vektoren4-Projektübersicht
========================================================================

Diese Vektoren4-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Vektoren4-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Vektoren4.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
